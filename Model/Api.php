...
namespace Salecto\Webshipper\Model;
...
class Api
{
    ...
    public function __construct(
        ...
        \Salecto\Webshipper\Model\Config $config,
    ...
    public function orderChannel($orderChannelId)
    {
        try {
            ...
            $this->logger->error(
                '\Salecto\Webshipper\Model\Api::OrderChannel :: Client Exception',
                [
            ...
            $this->logger->error(
                '\Salecto\Webshipper\Model\Api::OrderChannel :: Request Exception',
                [
                    'message' => $e->getMessage(),
                    'trace' => $e->getTraceAsString(),
                ]
            ...
            $this->logger->error(
                '\Salecto\Webshipper\Model\Api::OrderChannel :: Throwable Exception',
                [
                    'message' => $e->getMessage(),
                    'trace' => $e->getTraceAsString(),
                ]
    ...
    public function exportOrder(\Magento\Sales\Model\Order $order)
    {
        ...
        try {
            $response = $this->request(function (Client $client) use ($order) {
                ...
                $this->logger->debug(
                    '\Salecto\Webshipper\Model\Api::exportOrder :: Preflight',
                    [
                        'body' => $data
                    ]
                );
                ...
                $this->logger->debug(
                    '\Salecto\Webshipper\Model\Api::exportOrder :: Response',
                    [
            ...
            $this->logger->error(
                '\Salecto\Webshipper\Model\Api::exportOrder :: ERROR',
                [
    ...
    public function updateWebshipperLog($order_id, $increment_id, $webshipper_id, $state, $message)
    {
        ...
        try {
            ...
            $this->logger->error(
                '\Salecto\Webshipper\Model\Api::updateWebshipperLog :: ERROR',
                [
                    'message' => $e->getMessage(),
                    'trace' => $e->getTraceAsString(),
                ]
